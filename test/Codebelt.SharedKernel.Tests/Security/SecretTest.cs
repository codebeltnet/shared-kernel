...
namespace Codebelt.SharedKernel.Security
{
    public class SecretTest : Test
    {
        ...
        public SecretTest(ITestOutputHelper output) : base(output)
        {
        }
        ...
        [Theory]
        [MemberData(nameof(WhitespaceCharacters))]
        public void Constructor_ShouldThrowArgumentOutOfRangeException_WhenValueContainsWhitespace(string value)
        {
        ...
        public void Constructor_ShouldThrowArgumentOutOfRangeException_WhenValueHasLessThan32Characters()
        {
            ...
            Assert.StartsWith("The minimum length of value was not meet. (Parameter 'value')", sut.Message);
        ...
        public void Constructor_ShouldThrowArgumentOutOfRangeException_WhenValueHasExceeded128Characters()
        {
            ...
            Assert.StartsWith("The maximum length of value was exceeded. (Parameter 'value')", sut.Message);
